    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  
            ...
            if time > 1200:
                ...
                record_command_logs(user_id, '/bgmi_compiled', king, soulking, time)
            ...
            response = "✅A͢v͢a͢i͢l͢a͢b͢l͢e͢ r͢i͢g͢h͢t͢ n͢o͢w͢✅ :- /bgmi <king> <soulking> <time>"  
    else:
        response = " ★ 𝘈𝘤𝘤𝘦𝘴𝘴 𝘭𝘦 𝘭𝘦 𝘣𝘳𝘰 ★ ."
...
def welcome_start(message):
    ...
    response = f'''ıllıllı⭐🌟 W͙e͙l͙c͙o͙m͙e͙ t͙o͙ bgmi family ❣️ 🌟⭐ıllıllı \n {user_name}! \n🄱🄶🄼🄸 🄺🄸 🄶🄰🄽🄳 🄼🄰🅁🄽🄴 🄰🄰 🄶🅈🄴😜
